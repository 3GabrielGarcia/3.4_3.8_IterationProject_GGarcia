            ...
            <div id="navbar">
                ...
                <div>    
                    <ul>
                        ...
                        <li><div class="activepage"><a href="page2_V1.html" class="navtext"	>Request A Design</a></div></li>
                    </ul>	
                </div> 
            </div>
            <div id="burgermenu">
                        ...
                        <ul id="menu">
                            <li>
                                <ul id="navflex">
                                    <li><a href="index_V1.html" class="navtext">Home</a></li>
                                    <li><a href="page1_V1.html" class="navtext">Product Gallery</a></li>
                                    <li><div class="activepage"><a href="contact.php" class="navtext">Request A Design</a></div></li>
